...
The Bonferroni correction is generally deemed to be very conservative, especially when $m$ becomes large.\cite{5.4}\cite{5.1}\cite{5.3}\cite{5.5}. This is because, if we take $m=1000$ for instance, we will end up with a significance level of $\frac{0.05}{1000}=0.00005$, which is extremely small. Only few results will be significant under this setting, but the true number of significant results lies way beyond that, i.e. a high rate of false acceptance/negative.
